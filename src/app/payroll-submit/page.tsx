...
export default function PayrollSubmit() {
  ...
  // Show simple header for employees only
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {alert && (
          ...
          >
            <p className={`flex-1 text-sm ${alert.type === 'success' ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'}`}>
              {alert.message}
            </p>
            <button onClick={() => setAlert(null)} className={alert.type === 'success' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}>
              ✕
            </button>
          </div>
        )}
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold">
                {new Date(payDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-800">
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-white">
              {totals.productionCount}
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
              {totals.totalUnits.toFixed(0)} units
            </p>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <input
                          ...
                          step="0.01"
                          min="0"
                          max={emp.compensation_type === 'hourly' ? 80 : undefined}
                          value={
                          ...
                          placeholder={emp.compensation_type === 'hourly' ? 'Hours' : 'Units'}
                          className="w-24 px-3 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <input
                          ...
                          value={emp.notes}
                          onChange={(e) =>
                            handleInputChange(emp.id, 'notes', e.target.value)
                          }
                          placeholder="Optional notes"
                          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        />
                      </td>
                    </tr>
                  ))}
        ...
        <div className="mt-6 flex items-center justify-between">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Press <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded text-xs font-mono">Ctrl+Enter</kbd> to submit
          </p>
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-white shadow-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
              isSubmitting || totals.employees === 0
              ...
              <>
                ...
                {totals.employees > 0 && (
                  <span className="ml-1 rounded-full bg-white/20 px-2 py-0.5 text-xs">
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-700 dark:text-gray
