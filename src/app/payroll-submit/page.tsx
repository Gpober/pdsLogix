      ...
      <header style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '16px' }}>
          ...
          <p style={{ fontSize: '14px', opacity: 0.9 }}>
            {reportType === "ar" || reportType === "ap" ? "As of Today" : `${getMonthName(month)} ${year}`} â€¢ {properties.length}{" "}
                ...
                {filteredARTransactions.map((t, idx) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#64748b' }}>
                      <span>
                        {formatDate(t.invoiceDate)}{" "}â€¢ Due {formatDate(t.dueDate)}
                      </span>
              ...
              <div style={{ display: 'grid', gap: '12px' }}>
                {filteredAPTransactions.map((t, idx) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#64748b' }}>
                      <span>
                        {formatDate(t.billDate)}{" "}â€¢ Due {formatDate(t.dueDate)}
                      </span>
                      <span style={{ color: getAgingColor(t.daysOutstanding), fontWeight: '600' }}>
                        {t.daysOutstanding} days
                      </span>
