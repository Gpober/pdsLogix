...
type RankingMetric = "apTotal" | "apCurrent" | "apOverdue";
...
export default function APAgingDashboard() {
  ...
  return (
    <div style={{ 
      ...
      {/* Enhanced Header */}
      <header style={{
        background: `linear-gradient(135deg, ${BRAND_COLORS.danger}, #EC7063)`,
        borderRadius: '16px',
        padding: '20px',
        marginBottom: '24px',
        color: 'white',
        boxShadow: `0 8px 32px ${BRAND_COLORS.danger}33`
      }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '16px' }}>
          ...
          <p style={{ fontSize: '14px', opacity: 0.9 }}>
            As of Today • {properties.length} Vendors
          </p>
        </div>
      ...
      {menuOpen && (
        <div style={{
          ...
          <p style={{ margin: 0, fontSize: '14px', color: BRAND_COLORS.gray[600] }}>
            A/P Aging shows real-time outstanding payables.
          </p>
          <button
            style={{
              width: '100%',
        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '20px' }}>
              <Target size={20} style={{ color: BRAND_COLORS.danger }} />
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: BRAND_COLORS.danger }}>
                Vendor Insights
              </h3>
            </div>
            ...
            {/* Awards Section */}
            <div style={{
              background: `linear-gradient(135deg, ${BRAND_COLORS.gray[50]}, #fef2f2)`,
              borderRadius: '12px',
              padding: '16px',
              marginBottom: '16px',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '12px' }}>
                <Award size={16} style={{ color: BRAND_COLORS.danger }} />
              ...
              return (
                <div
                  ...
                  style={{
                    background: selectedProperty === p.name 
                      ? `linear-gradient(135deg, ${BRAND_COLORS.danger}15, #EC706315)` 
                      : 'white',
                    border: selectedProperty === p.name 
                      ? `3px solid ${BRAND_COLORS.danger}` 
                    ...
                    boxShadow: selectedProperty === p.name 
                      ? `0 8px 32px ${BRAND_COLORS.danger}40` 
                ...
                >
                  <div style={{
                    ...
                    width: '60px',
                    height: '60px',
                    background: `linear-gradient(135deg, ${BRAND_COLORS.danger}20, #EC706310)`,
                    borderRadius: '50%',
                    opacity: 0.6
                  }} />
                  ...
                  <div style={{ display: 'grid', gap: '6px' }}>
                    ...
                    <div style={{
                      ...
                      <span style={{ fontSize: '12px', fontWeight: '700', color: BRAND_COLORS.accent }}>Total A/P</span>
          ...
          <ol style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: '12px' }}>
            {rankedProperties.map((p, idx) => (
              ...
              >
                ...
                <span style={{ fontWeight: '600', color: BRAND_COLORS.danger }}>
      ...
      {view === "report" && (
        <div>
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '8px' }}>
              {selectedProperty || "Company Total"} - A/P Aging
            </h2>
            <p style={{ fontSize: '14px', opacity: 0.9 }}>
              As of Today
            </p>
